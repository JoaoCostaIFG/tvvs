...
configuration was based on the [Google code style configuration](https://github.com/checkstyle/checkstyle/blob/master/src/main/resources/google_checks.xml). Some rules were adapted to reduce the amount of irrelevant issues
(**false-positives**).
...
Changing these configurations, eliminates most warnings, but generates new ones that we consider **true-postives**.
...
[SpotBugs](https://spotbugs.github.io) is a program which uses heuristics to look for faults in Java code.
