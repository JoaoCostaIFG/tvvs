...
methods design problems, and it has also the ability to check code layout
...
The rules were adapted to reduce the amount of irrelevant issues. These changes are
listed below:
